...
<body>
    ...
    <div class="help-note">
        <strong>会議がまだ開始されていない場合（発信者の方へ）</strong><br>
        利用している環境では、<strong>発信者が必ず最初に「ミーティングに参加」を押す</strong>と通話が始まります。手順は次のとおりです。
        <ol style="margin: 10px 0 0 20px; padding-left: 8px;">
            <li><strong>発信者</strong>：通話画面で Jitsi の<strong>中央や下部にある青い「ミーティングに参加」ボタン</strong>を押す（「私はホストです」の表示がなくても同じボタンでかまいません）。</li>
            <li><strong>着信者</strong>：相手が「出る」を押したあと、同じく Jitsi 画面内の「ミーティングに参加」を押す。</li>
        </ol>
        それでも繋がらない場合は、一度通話を終了してからかけ直してみてください。
    </div>
