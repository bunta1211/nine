...
<body>
    ...
    <div class="help-note">
        ...
        利用している環境によっては、通話が「モデレーター待ち」の状態になることがあります。発信者の画面で Jitsi 内に<strong>青い「ミーティングに参加」ボタン</strong>（または「私はホストです」「Start meeting」）が出ている場合は、<strong>発信者</strong>がそれを押すと通話が始まります。相手には「ミーティングに参加」を押してもらってください。それでも繋がらない場合は、一度通話を終了してからかけ直してみてください。
    </div>
