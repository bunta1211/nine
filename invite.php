...
<body>
    <div class="invite-card">
        ...
        <?php elseif ($showRegistrationForm && $invitation): ?>
            ...
            <?php else: ?>
                <div class="invite-title">Social9への招待</div>
            ...
            <?php else: ?>
                <div class="inviter-name"><?= htmlspecialchars($inviter['display_name']) ?>さんが</div>
                <div class="inviter-message">あなたをSocial9へ招待しています</div>
            <?php endif; ?>
            ...
            <form method="POST" action="">
                ...
                <button type="submit" class="btn btn-primary">登録してSocial9を始める</button>
            </form>
        ...
        <?php elseif ($inviter && !isset($_SESSION['user_id'])): ?>
            ...
            <div class="invite-subtitle">Social9で友達になりましょう</div>
            ...
            <div class="login-prompt">
                <p>Social9アカウントをお持ちの方はログインしてください。<br>アカウントをお持ちでない方は新規登録してください。</p>
            </div>
