...
| `access_logger.php` | アクセスログ記録・集計（log_page_access, get_access_stats_today）。本日のアクセス・検索経由・離脱率。access_log テーブル利用。config/database.php と config/app.php 前提 | index.php, chat.php, admin/index.php |
