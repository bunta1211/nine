...
| `login-landing.css` | ログイン画面（ランディング）専用。body.page-login の上パネル余白・main-container 左・中央パネルレイアウト（右パネルは廃止済み）、左パネル内ログインフォーム（.login-panel-form）、中央のキャッチ・機能・用途コンテンツ、フッター、768px 以下で縦積み。DOCS/LOGIN_LANDING_PLAN.md 参照 | index.php |
